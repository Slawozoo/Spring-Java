package com.jersey.restapi.model;
...
public class Author {
	...
	@JsonCreator
	public Author(@JsonProperty("authorId") int authorId, @JsonProperty("firstName")String firstName, @JsonProperty("lastName")String lastName,
