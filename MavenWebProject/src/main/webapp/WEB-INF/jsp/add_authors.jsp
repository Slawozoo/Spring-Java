...
<div class="container mt-5">
  <div class="card " style="width: 25rem; ">
    <div class="card-body">
      <h5 class="card-title " align="center" >Add Authors</h5>
      <f:form modelAttribute="authors" action="add_authors" method="post">
       <f:input path="authorId" class="form-control" />
        ...
        <center>    <input type="submit" value="Add Authors" class="btn btn-warning"></center>
        </div>
      </f:form>
    </div>
  </div>
